...
Доступные разрешения: Best (автоматический выбор), 2160p (4K), 1440p, 1080p, 720p, 480p, 360p, 240p.
...
Для аудио программа автоматически скачивает обложку видео и встраивает её в файл как обложку альбома. Это работает для MP3 и M4A.
